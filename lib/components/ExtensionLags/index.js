...
export const ExtensionLag = class SampleTable extends Component {
    ...
    render() {
        ...
        const { ExtensionLagState, onSelectMethod, clickedIndex } = this.props;
        ...
        return (
            <View style={styles.container}>
                ...
                <Table borderStyle={{ borderWidth: 2, borderColor: '#00403C' }}>
                    {
                        ExtensionLagState.map((rowData, index) => {
