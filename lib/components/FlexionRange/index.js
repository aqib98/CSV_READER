...
export const FlexionRange = class SampleTable extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { FlexionRangeState, onSelectMethod, clickedIndex } = this.props;
        ...
        return (
            <View style={styles.container}>
                ...
                <Table borderStyle={{ borderWidth: 2, borderColor: '#00403C' }}>
                    {
                        FlexionRangeState.map((rowData, index) => {
