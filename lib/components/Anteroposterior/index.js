...
export const Anteroposterior = class SampleTable extends Component {
    ...
    render() {
        ...
        const { AnteroposteriorState, onSelectMethod, clickedIndex } = this.props;
        ...
        return (
            <View style={styles.container}>
                ...
                <Table borderStyle={{ borderWidth: 2, borderColor: '#00403C' }}>
                    {
                        AnteroposteriorState.map((rowData, index) => {
